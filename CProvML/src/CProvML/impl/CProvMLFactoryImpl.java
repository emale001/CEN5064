...
public class CProvMLFactoryImpl extends EFactoryImpl implements CProvMLFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CProvMLPackage.SECURITY_GROUP: return createSecurityGroup();
			case CProvMLPackage.NETWORK: return createNetwork();
			case CProvMLPackage.ENVIRONMENT: return createEnvironment();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			...
			case CProvMLPackage.CPU_TYPE:
				return createCPUTypeFromString(eDataType, initialValue);
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			...
			case CProvMLPackage.CPU_TYPE:
				return convertCPUTypeToString(eDataType, instanceValue);
			case CProvMLPackage.STORAGE_TYPE:
	 ...
	 * @generated
	 */
	public CPUType createCPUTypeFromString(EDataType eDataType, String initialValue) {
		CPUType result = CPUType.get(initialValue);
		if (result == null) throw new IllegalArgumentException("The value '" + initialValue + "' is not a valid enumerator of '" + eDataType.getName() + "'");
		return result;
	}
	 ...
	 * @generated
	 */
	public String convertCPUTypeToString(EDataType eDataType, Object instanceValue) {
		return instanceValue == null ? null : instanceValue.toString();
	}
