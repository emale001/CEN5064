 ...
 * @generated
 */
public class CProvMLModelingAssistantProviderOfInstanceEditPart extends
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((CProvML.diagram.edit.parts.InstanceEditPart) sourceEditPart);
	}
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source,
		...
		return doGetRelTypesOnSourceAndTarget(
				(CProvML.diagram.edit.parts.InstanceEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target
				.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((CProvML.diagram.edit.parts.InstanceEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			CProvML.diagram.edit.parts.InstanceEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(CProvML.diagram.providers.CProvMLElementTypes.Connection_4001);
		return types;
	}
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(CProvML.diagram.edit.parts.InstanceEditPart) targetEditPart,
				relationshipType);
	}
