package CProvML.diagram.expressions;
 ...
 * @generated
 */
public class CProvMLOCLFactory {

	/**
	 * @generated
	 */
	private final CProvML.diagram.expressions.CProvMLAbstractExpression[] expressions;
	 ...
	 * @generated
	 */
	private static CProvMLOCLFactory getInstance() {
		CProvMLOCLFactory instance = CProvML.diagram.part.CProvMLDiagramEditorPlugin
				.getInstance().getCProvMLOCLFactory();
		if (instance == null) {
			CProvML.diagram.part.CProvMLDiagramEditorPlugin.getInstance()
					.setCProvMLOCLFactory(instance = new CProvMLOCLFactory());
		}
		return instance;
	}
	 ...
	 * @generated
	 */
	public static CProvML.diagram.expressions.CProvMLAbstractExpression getExpression(
			int index, EClassifier context, Map<String, EClassifier> environment) {
		CProvMLOCLFactory cached = getInstance();
	...
	private static class Expression extends
			CProvML.diagram.expressions.CProvMLAbstractExpression {
