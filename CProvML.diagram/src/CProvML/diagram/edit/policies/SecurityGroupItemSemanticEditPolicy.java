 ...
 * @generated
 */
public class SecurityGroupItemSemanticEditPolicy extends
		CProvML.diagram.edit.policies.CProvMLBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public SecurityGroupItemSemanticEditPolicy() {
		super(CProvML.diagram.providers.CProvMLElementTypes.SecurityGroup_2003);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (CProvML.diagram.part.CProvMLVisualIDRegistry
					.getVisualID(incomingLink) == CProvML.diagram.edit.parts.ConnectionEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (CProvML.diagram.part.CProvMLVisualIDRegistry
					.getVisualID(outgoingLink) == CProvML.diagram.edit.parts.ConnectionEditPart.VISUAL_ID) {
				DestroyElementRequest r = new DestroyElementRequest(
	...
	protected Command getStartCreateRelationshipCommand(
		...
		if (CProvML.diagram.providers.CProvMLElementTypes.Connection_4001 == req
				.getElementType()) {
	...
	protected Command getReorientRelationshipCommand(
		...
		case CProvML.diagram.edit.parts.ConnectionEditPart.VISUAL_ID:
			return getGEFWrapper(new CProvML.diagram.edit.commands.ConnectionReorientCommand(
					req));
		}
