 ...
 * @generated
 */
public abstract class CProvMLAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = CProvML.diagram.part.CProvMLDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected CProvMLAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
