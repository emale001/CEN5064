...
import cprovml.ee.utility.EnvironmentShape;

/**
 * @generated
 */
public class EnvironmentEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new CProvML.diagram.edit.policies.EnvironmentItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new EnvironmentFigure();
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CProvML.diagram.edit.parts.EnvironmentNameEditPart) {
			((CProvML.diagram.edit.parts.EnvironmentNameEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureEnvironmentNameFigure());
			return true;
		}
		return false;
	}
	...
	public class EnvironmentFigure extends EnvironmentShape {
		 ...
		 * @generated
		 */
		private Label fFigureEnvironmentNameFigure;
		 ...
		 * @generated
		 */
		public Label getFigureEnvironmentNameFigure() {
			return fFigureEnvironmentNameFigure;
		}
