...
import cprovml.ee.utility.NetworkShape;
...
public class NetworkEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new CProvML.diagram.edit.policies.NetworkItemSemanticEditPolicy());
	...
	protected IFigure createNodeShape() {
		return primaryShape = new NetworkFigure();
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof CProvML.diagram.edit.parts.NetworkNameEditPart) {
			((CProvML.diagram.edit.parts.NetworkNameEditPart) childEditPart)
	...
	public class NetworkFigure extends NetworkShape {
		 ...
		 * @generated
		 */
		private Label fFigureNetworkNameFigure;
		 ...
		 * @generated
		 */
		public Label getFigureNetworkNameFigure() {
