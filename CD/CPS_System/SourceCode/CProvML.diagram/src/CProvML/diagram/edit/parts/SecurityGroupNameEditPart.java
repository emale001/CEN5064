 ...
 * @generated
 */
public class SecurityGroupNameEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SecurityGroupNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new CProvML.diagram.edit.policies.CProvMLTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CProvML.diagram.providers.CProvMLParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					CProvML.diagram.edit.parts.CProvMLEditPartFactory
