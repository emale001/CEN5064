...
/**
 * This is the item provider adapter for a {@link CProvML.Network} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NetworkItemProvider extends NodeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Network_Type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Network_Type_feature", "_UI_Network_type"),
				 CProvMLPackage.Literals.NETWORK__TYPE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Network.class)) {
			case CProvMLPackage.NETWORK__TYPE:
