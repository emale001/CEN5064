...
public class CustomShape extends Figure {

	public CustomShape(String path) {
		GridLayout layout = new GridLayout(2, false);
		super.setLayoutManager(layout);
		add(new ImageFigure(getImage(path)), new GridData(SWT.BEGINNING, SWT.BEGINNING, false, false, 1, 2));
	}
	...
	protected Image getImage(String path) {
		...
		if (image == null) {
			ImageDescriptor descriptor = AbstractUIPlugin.imageDescriptorFromPlugin("CProvML.ee", path); //$NON-NLS-1$
			if (descriptor == null) {
